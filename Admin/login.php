                ...
                <div class="card-body">
                  ...
                  <?php
                    ...
                    if (!empty($_POST)) {
                      ...
                      $pas=md5($_POST['pas']);
                      $sel="SELECT * FROM user_data NATURAL JOIN user_role WHERE user_username='$username' AND user_pas='$pas'";
                  ...
                  <form class="form-signin" method="POST"> 
                    ...
                    <input type="password" class="form-control mb-2"  name="pas" placeholder="Password" required>
