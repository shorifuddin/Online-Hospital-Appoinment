		  ...
		  <div class="collapse navbar-collapse" id="navbarmain">
			<ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item dropdown">
					<a href="appoinment.php" class="nav-link dropdown-toggle" href="doctor.php" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Appoinment <i class="icofont-thin-down"></i></a>
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
					<li class="nav-item"><a class="nav-link" href="appoinment.php">Appoinment</a></li>
						<li><a class="dropdown-item" href="confirmation.php">Confirmated Appointments</a></li>
